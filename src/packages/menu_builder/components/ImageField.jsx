...
const ImageField = ({ field, value, onChange }) => {
  ...
  return (
    <div 
      id={id}
      className="w-full max-w-md mx-auto bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4 hover:shadow-md transition-shadow duration-200"
    >
      {/* Image Preview Section */}
      <div className="flex flex-col items-center space-y-3">
        <div className="relative group">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-lg overflow-hidden bg-gray-50 border-2 border-dashed border-gray-200 group-hover:border-blue-300 transition-colors duration-200">
            <ImageCustom
              ref={imageRef}
              src="/next.svg"
              height={112}
      ...
      <div className="space-y-3">
        <div className="relative">
          ...
          <input
            ...
            ref={urlRef}
            onBlur={handleBlur}
            className="w-full px-4 py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 placeholder-gray-400 bg-gray-50 focus:bg-white"
          />
        </div>
