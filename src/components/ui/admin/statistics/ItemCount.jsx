...
const ItemCount = ({ item, ...props }) => {
  ...
  return (
    <LinkCustom href={process.env.NEXT_PUBLIC_ADMIN_URL + item?.link} {...props}>
      <div className={`rounded-lg py-5 px-4 flex items-center justify-between ${item.class} transition-all hover:shadow-lg`}>
