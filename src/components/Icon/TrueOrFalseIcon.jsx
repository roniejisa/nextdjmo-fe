const TrueOrFalseIcon = ({ isValid }) => {
  return (
    <>
      {isValid ? (
        <span className="text-green-500 w-6 absolute right-2 top-1/2 -translate-y-1/2">
          <svg
        ...
        <span className="text-red-500 w-6 absolute right-2 top-1/2 -translate-y-1/2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
